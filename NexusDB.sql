-- NexusDB.sql
-- Master database schema for The Nexus server fork.
-- This script provisions a fresh MySQL schema with all tables, triggers,
-- and seed data expected by the current game server build.
